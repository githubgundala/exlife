...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>exlife</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block" style="background-color: #20c997">Masuk</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
    ...
    <!-- /.login-card-body -->
    @if (session('alertlogin') == TRUE)
    <div class="col-sm-12">
      <div class="alert alert-danger alert-dismissible">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5>Cek Username dan Password anda !</h5>
      </div>
    </div>
    @endif
  </div>
