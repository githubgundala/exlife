  ...
  <div class="card-body">
    <table id="example2" class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <td>
        <div class="col-sm-2">
          <a href="https://via.placeholder.com/1200/000000.png?text={{ $i }}" data-toggle="lightbox" data-title="sample {{ $i }} - black" data-gallery="gallery">
            <img src="https://via.placeholder.com/300/000000?text={{ $i }}" class="img-fluid mb-2" alt="black sample">
          </a>
        </div>
      </td>
      </tr>
